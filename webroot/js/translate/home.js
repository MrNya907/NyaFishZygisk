export function translateHomePage(old_translations, new_translations) {
  ...
  switch (nyafishzygisk_state.innerHTML.replace(/(\r\n|\n|\r)/gm, '').trim()) {
    case old_translations.page.home.status.ok: {
      nyafishzygisk_state.innerHTML = new_translations.page.home.status.ok

      break
    }
    case old_translations.page.home.status.partially: {
      nyafishzygisk_state.innerHTML = new_translations.page.home.status.partially

      break
    }
    case old_translations.page.home.status.notWorking: {
      nyafishzygisk_state.innerHTML = new_translations.page.home.status.notWorking

      break
    }
    case old_translations.page.home.status.unknown: {
      nyafishzygisk_state.innerHTML = new_translations.global.unknown
