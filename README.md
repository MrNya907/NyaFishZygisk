...
nyafishzygisk is a fork of Zygisk Next, a standalone implementation of Zygisk, providing Zygisk API support for KernelSU, APatch and Magisk (Official and Kitsune).
...
The selection of the build/zip is important, as it will determine how hidden and stable nyafishzygisk will be. This, however, is not a hard task:
...
- For translations of the nyafishzygisk WebUI, you should first contribute to our [Crowdin](https://crowdin.com/project/nyafishzygisk). Once approved retrieve the `.json` file from there and open a pull request with your changes -- adding the `.json` file to the `webroot/lang` folder and your credits to the `TRANSLATOR.md` file, in alphabetic order.

## Support

For any question related to nyafishzygisk or other PerformanC projects, feel free to join any of the following channels below:

- Discord Channel: [PerformanC](https://discord.gg/uPveNfTuCJ)
- nyafishzygisk Telegram Channel: [@nyafishzygisk](https://t.me/nyafishzygisk)
...
It is mandatory to follow PerformanC's [Contribution Guidelines](https://github.com/PerformanC/contributing) to contribute to nyafishzygisk. Following its Security Policy, Code of Conduct, and syntax standard.

## License

nyafishzygisk is licensed majoritaly under GPL, by Dr-TSNG, but also AGPL 3.0, by The PerformanC Organization, for re-written code. You can read more about it on [Open Source Initiative](https://opensource.org/licenses/AGPL-3.0).
